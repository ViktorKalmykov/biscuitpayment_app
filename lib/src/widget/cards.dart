...
import 'biscuitpayment_app/src/models/hex_color.dart';
...
class CreditCard extends StatelessWidget {
  ...
  CreditCard({required this.color, required this.image, required this.number, required this.valid});
